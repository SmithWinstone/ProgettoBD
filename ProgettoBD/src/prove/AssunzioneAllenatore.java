...
public class AssunzioneAllenatore extends JFrame {
	...
	private JPanel contentPane;
  	...
  	public static void main(String[] args) {
  		EventQueue.invokeLater(new Runnable() {
  			public void run() {
  				try {
  					AssunzioneAllenatore frame = new AssunzioneAllenatore();
  	...
  	*/
  	public AssunzioneAllenatore() {
  		...
  		lblSpecializzazione.setBounds(10, 252, 80, 16);
  		...
  		esperienza.setBounds(10, 171, 49, 22);
  		...
  		JLabel lblDocumentoSpecializzazione = new JLabel("Documento specializzazione");
  		lblDocumentoSpecializzazione.setBounds(10, 301, 145, 16);
  		contentPane.add(lblDocumentoSpecializzazione);
  		
  		telefonoAllenatore = new JTextField();
  		telefonoAllenatore.setColumns(10);
  		telefonoAllenatore.setBounds(78, 171, 228, 22);
  		contentPane.add(telefonoAllenatore);
  		
  		JLabel lblTelefono = new JLabel("Telefono");
  		lblTelefono.setBounds(78, 155, 80, 16);
  		contentPane.add(lblTelefono);
  		
  		JButton btnAssunzione = new JButton("Assunzione");
  		...
  		btnAssunzione.setBounds(10, 358, 126, 37);
  		contentPane.add(btnAssunzione);
  		
  		JLabel lblContratto = new JLabel("Contratto");
  		lblContratto.setBounds(10, 204, 80, 16);
