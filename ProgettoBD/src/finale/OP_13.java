  ...
  */
   ...
   */
	public OP_13() {
		...
		JLabel lblDescrizione = new JLabel("Descrizione corso");
		...
		JLabel lblCodice = new JLabel("Codice attivit\u00E0");
		...
		JLabel lblPeriodicita = new JLabel("Periodicit\u00E0 settimanale");
		...
		JLabel lblCfAllenatore = new JLabel("Eventuale CF allenatore");
		...
		JLabel lblEventualeSpecializzazione = new JLabel("Eventuale Specializzazione richiesta");
		lblEventualeSpecializzazione.setBounds(10, 232, 237, 16);
		contentPane.add(lblEventualeSpecializzazione);
		
		specializzazione = new JTextField();
		specializzazione.setColumns(10);
		specializzazione.setBounds(10, 246, 294, 22);
		contentPane.add(specializzazione);
		
		data = new JTextField();
		data.setColumns(10);
		data.setBounds(11, 297, 135, 22);
		contentPane.add(data);
		
		lblData = new JLabel("Data");
		lblData.setBounds(10, 279, 148, 16);
		contentPane.add(lblData);
		
		ora = new JTextField();
		ora.setColumns(10);
		ora.setBounds(157, 297, 135, 22);
		contentPane.add(ora);
		
		lblOra = new JLabel("Ora");
		lblOra.setBounds(156, 279, 148, 16);
